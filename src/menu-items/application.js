  ...
  children: [
    ...
    // },
    {
      ...
      children: [
        {
          id: 'product_Stock',
          title: <FormattedMessage id='product_Stock' />,
          type: 'item',
          url: '/app/products',
          breadcrumbs: true,
        },
        {
          id: 'material-stock',
          title: <FormattedMessage id='material-stock' />,
          type: 'item',
          url: '/app/material',
          breadcrumbs: true,
        },
    ...
    {
      id: 'hrms',
      title: <FormattedMessage id='hrms' />,
      type: 'collapse',
