...
const LayoutContent = styled(Grid)(({ theme }) => ({
  ...
  '&:after': {
    ...
    position: 'absolute',
    background:
      theme.palette.mode === 'dark' ? theme.palette.dark.dark : '#FFFFFF',
  ...
  '&:before': {
    ...
    position: 'absolute',
    background:
      theme.palette.mode === 'dark' ? theme.palette.dark.main : '#9E9E9E',
    width: 1,
    height: 390,
    top: 13,
    left: -8,
                ...
                <LayoutContent container spacing={2}>
                  ...
                  <Grid item sm={12}>
                    <Typography variant='body2'>
                      Modern, sleek and elegant dark color scheme that looks
                      great in a dark variant.
                    </Typography>
                  </Grid>
                </LayoutContent>
              </Grid>
