...
import { COLUMNS } from '@/utils/react-table-util/ProductPurchaseColumns';
import { getAllPurchasingProduct } from '@/service/PurchasingService';
import AddEditPurchaseProduct from './AddEditPurchaseProduct';
import { gridSpacing } from '@/store/constant';

// ==============================|| PRODUCT LIST ||============================== //

const ProductPurchaseBill = () => {
  ...
  const onAddExpense = () => {
    console.log('Add Product Purchase form route');
    setIsModelOpen(true);
    setAdd(true);
  };
  ...
  const data = useMemo(() => purchaseList, [purchaseList]);
  ...
  return (
    <MainCard title='Product Purchasing List' content={false}>
      <CardContent>
        <Grid
          container
...
export default ProductPurchaseBill;
