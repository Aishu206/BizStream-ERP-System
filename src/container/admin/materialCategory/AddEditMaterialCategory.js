...
import { addMaterialCategory } from '@/service/AdminService';
...
const AddEditMaterialCategory = ({ onCancel, formValues }) => {
  ...
  const onSubmit = (values) => {
    addMaterialCategory({ ...values }).then((data) => {
...
export default AddEditMaterialCategory;
